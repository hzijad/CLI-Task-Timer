...
router.get('/', function(req, res, next) {
    ...
    switch (userCommand){
        case "start":
            allTimers.startTimer(userCommandTarget)
            break;
        case "create":
            allTimers.createTimer(userCommandTarget)
            break;
        case "pause":
            allTimers.pauseTimer(userCommandTarget)
            break;
        case "reset":
            allTimers.resetTimer(userCommandTarget)
            break;
        case "getStatus":
            res.json({message:"Status of timer: "+allTimers.getStatusTimer(userCommandTarget)})
            break;
        case "getElapsedTime":
            res.json({message:"Elapsed time since last action: "+allTimers.getElapsedTimeTimer(userCommandTarget)})
            break;
        case "getUid":
